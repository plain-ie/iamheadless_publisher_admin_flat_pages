...
PYDANTIC_MODEL = pydantic_models.FlatPagePydanticModel


class FlatPageCreateViewSet(BaseItemCreateViewSet):
...
class FlatPageRetrieveUpdateViewSet(BaseItemRetrieveUpdateViewSet):
...
class FlatPageDeleteViewSet(BaseItemDeleteViewSet):
